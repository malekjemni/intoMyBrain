...
public class InputManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        controls.PauseMenu.started += PauseMenu_started;
    }

    private void CancelOperation_started(InputAction.CallbackContext obj) => CancelOperation?.Invoke();
    private void PauseMenu_started(InputAction.CallbackContext obj) => PauseMenu?.Invoke();
