...
public class EndorphinEmissaryUpgradeHandler : TowerUpgradeHandler
{
    private AbilityHandler abilityHandler;
    private AbilityManager abilityManager;
    private EndorphinEmissary endorphinEmissary;
    ...
    protected override void InitUpgrades(TowerBase towerBase)
    {
        ...
        endorphinEmissary = towerBase as EndorphinEmissary;
        ...
        {
            endorphinEmissary.useHitscan = true;
        }));
